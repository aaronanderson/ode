...
public class InsertObjectTest extends TestCase {
    ...
    DataSource _ds;
    BpelDAOConnectionFactory factory;
    ProcessDAO _process;
	...
	protected void setUp() throws Exception {
        ...
        JDBCContext ctx = new JDBCContext(_ds, _txm, true);
        OdeConfigProperties props = new OdeConfigProperties(new File(getClass().getResource("/ode.properties").toURI().getPath()), "test.");
        props.load();
        factory = (BpelDAOConnectionFactory) Class.forName(props.getDAOConnectionFactory()).newInstance();
        factory.init(props.getProperties(),ctx);
    ...
    void createStuff(BpelDAOConnectionFactory factory) throws Exception {
