...
public class ConfStoreDAOConnectionFactoryImpl implements ConfStoreDAOConnectionFactory {
    ...
    public void init(Properties initialProps, Object env) {
        ...
        __log.debug("using data source: " + _ctx.getDataSource());
        _dataSources.put(_guid, _ctx.getDataSource());
    ...
    public ConfStoreDAOConnectionImpl getConnection() {
        return new ConfStoreDAOConnectionImpl(_sessionFactory.openSession());
    }
